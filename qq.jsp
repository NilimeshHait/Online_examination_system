...
<font color="#0033ff" size="5">
<b>Seconds remaining: <input type="text" name="clock" value="<%=clock%>" style="border:4px solid #cccccc;color:red;background-color:#cccccc; font-size:20px" size="4"> 
</b>
</font>
</td>
</tr>
